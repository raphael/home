...
(defun font-scale-hidpi ()
  1.3)

(defun font-scale-lodpi ()
  1.0)

(defun font-size-hidpi ()
  25)

(defun font-size-lodpi ()
  15)
...
(defun font-size ()
  (if (equal (shell-command-to-string "/home/raphael/scripts/emacs_screen.sh") "0\n")
      (font-size-hidpi)
    (font-size-lodpi)))

(defun modeline-font-height ()
  (if (equal (shell-command-to-string "/home/raphael/scripts/emacs_screen.sh") "0\n")
      100
    50))
...
values."
  ...
  (setq-default
   ;; Font size detection
   dotspacemacs-default-font (list (font-name) :size (font-size) :weight 'normal :width 'normal :powerline-scale (font-scale))
...
you should place your code here."
  ;; inc/dec at point
  (define-key evil-normal-state-map (kbd "C-a") 'spacemacs/evil-numbers-transient-state/evil-numbers/inc-at-pt)
  (define-key evil-normal-state-map (kbd "C-S-a") 'spacemacs/evil-numbers-transient-state/evil-numbers/dec-at-pt)

  ;; C-]
  (evil-define-key '(normal insert) go-mode-map (kbd "C-]") 'go-guru-definition)
  ...
  (set-face-foreground 'git-gutter+-modified "#d79921")
  (set-face-background 'git-gutter+-modified "#d79921")
  (set-face-foreground 'git-gutter+-added "#98971a")
  (set-face-background 'git-gutter+-added "#98971a")
  (set-face-foreground 'git-gutter+-deleted "#cc241d")
  (set-face-background 'git-gutter+-deleted "#cc241d")
  ...
  (let ((faces '(mode-line
                 ...
                 mode-line-inactive)))
    (mapc
     (lambda (face) (set-face-attribute face nil :font (modeline-font) :height (modeline-font-height)))
     faces))
